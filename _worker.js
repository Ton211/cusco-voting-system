...
function withSecurityHeaders(response, pathname) {
  ...
  if (!headers.has('Content-Security-Policy'))
    headers.set(
      ...
      "default-src 'self'; script-src 'self' blob: https://www.gstatic.com https://www.google.com; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://www.googleapis.com https://storage.googleapis.com https://firebasestorage.googleapis.com https://www.gstatic.com https://www.google.com https://africa-south1-cusco-voting-2026.cloudfunctions.net https://us-central1-cusco-voting-2026.cloudfunctions.net blob:; frame-src https://www.google.com https://recaptcha.google.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'; object-src 'none'; upgrade-insecure-requests"
    );
